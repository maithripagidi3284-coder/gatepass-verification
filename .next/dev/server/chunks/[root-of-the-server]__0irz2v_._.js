...
"[project]/gatepass/src/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`login:${(0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req)}`, 10, 60_000)) {
    ...
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(email);
    // Same error for "no such user" and "wrong password" — don't leak which one it was.
    if (!user || user.status !== "active" || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.passwordHash)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const linkedId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLinkedIdForUser"])(user.id, user.role);
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSessionToken"])({
        userId: user.id,
        name: user.name,
        role: user.role,
        linkedId
    });
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setSessionCookie"])(token);
    return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        role: user.role,
        name: user.name
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0irz2v_._.js.map