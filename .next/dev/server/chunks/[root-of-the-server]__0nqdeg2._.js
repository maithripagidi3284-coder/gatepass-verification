...
"[project]/gatepass/src/app/api/verification/return/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/gatepass/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/gatepass/src/lib/rateLimit.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireRole"])("security", "admin");
    if (!session) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Sign in as security to do this."
    }, {
        status: 403
    });
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(`verify:${(0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req)}`, 60, 60_000)) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sweepExpired"])();
    const { token } = await req.json();
    if (!token) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Missing token"
    }, {
        status: 400
    });
    const pass = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGatePassByToken"])(token);
    if (!pass) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid or unknown pass token."
    }, {
        status: 404
    });
    if (pass.status === "RETURNED") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
            passId: pass.id,
            eventType: "REUSE_ATTEMPT",
            actor: session.name,
            details: "Return scan attempted on a pass already marked returned.",
            result: "DENIED"
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Return has already been recorded for this pass."
        }, {
            status: 409
        });
    }
    if (pass.status !== "EXITED") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
            ...
            actor: session.name,
            details: "Return scan attempted before exit was recorded.",
            result: "DENIED"
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Student has not been recorded as exited yet."
        }, {
            status: 400
        });
    }
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["consumeReturn"])(token);
    if (!ok) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "This pass was just updated by another scan."
    }, {
        status: 409
    });
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
        ...
        eventType: "RETURN_VERIFIED",
        actor: session.name,
        details: "Identity confirmed at gate, return recorded.",
        result: "SUCCESS"
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...pass,
...
"[project]/gatepass/src/lib/db.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$postgres$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/gatepass/node_modules/postgres/src/index.js [app-route] (ecmascript)");
;
let sql = null;
function getSql() {
    if (!sql) {
        ...
        sql = (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$postgres$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(process.env.DATABASE_URL, {
            ssl: "require"
        });
    }
    return sql;
...
async function findUserByEmail(email) {
    const db = getSql();
    const rows = await db`SELECT id, name, email, password_hash, role, status FROM users WHERE lower(email) = lower(${email})`;
...
async function getLinkedIdForUser(userId, role) {
    const db = getSql();
    if (role === "student") {
        const rows = await db`SELECT id FROM students WHERE user_id = ${userId}`;
        return rows[0]?.id;
    }
    if (role === "mentor") {
        const rows = await db`SELECT id FROM mentors WHERE user_id = ${userId}`;
        return rows[0]?.id;
    }
    return undefined;
}
...
async function listMentors() {
    const db = getSql();
    const rows = await db`SELECT id, name FROM mentors`;
    return rows;
}
async function createMentorRecord(name, userId) {
    const db = getSql();
...
async function createGatePass(input) {
    const db = getSql();
    try {
        const rows = await db`
...
async function listGatePasses(filters) {
    const db = getSql();
    const rows = await db`
    SELECT
...
async function mentorSetStatus(id, mentorId, newStatus) {
    const db = getSql();
    const rows = await db`
    UPDATE gate_passes
...
async function hodApprovePass(id) {
    const db = getSql();
  ...
  `;
    ...
    return {
        token,
        validUntil: new Date(rows[0].valid_until).getTime()
    };
}
async function hodRejectPass(id) {
    const db = getSql();
    const rows = await db`
...
async function consumeExit(token) {
    const db = getSql();
    const rows = await db`
...
async function consumeReturn(token) {
    const db = getSql();
    const rows = await db`
...
async function overrideExit(rollNo) {
    const db = getSql();
    const rows = await db`
...
async function overrideReturn(rollNo) {
    const db = getSql();
    const rows = await db`
    UPDATE gate_passes gp
...
async function listAuditHistory(limit = 50) {
    const db = getSql();
    const rows = await db`
...
"[project]/gatepass/src/lib/rateLimit.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0nqdeg2._.js.map