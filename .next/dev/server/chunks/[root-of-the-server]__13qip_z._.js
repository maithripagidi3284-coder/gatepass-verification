...
"[project]/gatepass/src/app/api/verification/exit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (pass.status === "EXITED" || pass.status === "RETURNED") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
            ...
            actor: session.name,
            details: "Exit scan attempted on a pass already marked exited.",
            result: "DENIED"
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "This pass has already been used for exit."
        }, {
            status: 409
        });
    }
    if (pass.status !== "APPROVED") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
            ...
            actor: session.name,
            details: DENY_REASONS[pass.status] ?? "Pass not valid for exit.",
            result: "DENIED"
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: DENY_REASONS[pass.status] ?? "Pass not valid for exit."
        }, {
            status: 400
        });
    }
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["consumeExit"])(token);
    if (!ok) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
            passId: pass.id,
            eventType: "REUSE_ATTEMPT",
            actor: session.name,
            details: "Concurrent exit scan lost the race.",
            result: "DENIED"
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "This pass was just used by another scan."
        }, {
            status: 409
        });
    }
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditEvent"])({
        ...
        eventType: "EXIT_VERIFIED",
        actor: session.name,
        details: "Identity confirmed at gate, exit recorded.",
        result: "SUCCESS"
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...pass,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13qip_z._.js.map