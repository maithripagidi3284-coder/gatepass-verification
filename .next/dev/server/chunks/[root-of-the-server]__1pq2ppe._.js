...
"[project]/gatepass/src/app/api/gatepass/[id]/mentor-approve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireRole"])("mentor");
    if (!session || !session.linkedId) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Sign in as a mentor to do this."
    }, {
        status: 403
    });
    const { id } = await params;
    const pass = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGatePassById"])(id);
    ...
    if (pass.status !== "PENDING_MENTOR") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not pending mentor approval"
        }, {
            status: 400
        });
    }
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mentorSetStatus"])(id, session.linkedId, "MENTOR_APPROVED");
    if (!ok) return __TURBOPACK__imported__module__$5b$project$5d2f$gatepass$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Could not approve — status may have changed."
    }, {
        status: 409
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1pq2ppe._.js.map